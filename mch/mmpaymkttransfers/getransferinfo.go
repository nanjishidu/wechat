...
func GetTransferInfo(mchTLSClient *mchcore.Client, partner_trade_no string) (resp map[string]string, err error) {
	if partner_trade_no == "" {
	...
	return mchmmpaymkttransfers.GetTransferInfo(mchTLSClient, req)
}
