...
//查询订单
func OrderQuery2(mchClient *mchcore.Client, outTradeNo string, params ...string) (resp *mchpay.OrderQueryResponse, err error) {
	var transactionId string
	if len(params) > 0 {
		transactionId = params[0]
	}
	req := &mchpay.OrderQueryRequest{
		TransactionId: transactionId,
		OutTradeNo:    outTradeNo,
	}
	resp, err = mchpay.OrderQuery2(mchClient, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
