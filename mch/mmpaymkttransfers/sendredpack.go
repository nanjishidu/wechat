...
//PRODUCT_7:彩票派奖
//PRODUCT_8:税务刮奖
func SendRedPack(mchTLSClient *mchcore.Client, appId, mchId, subAppId, subMchId, mch_billno, send_name, re_openid, wishing, act_name, remark string,
	...
	return mchmmpaymkttransfers.SendRedPack(mchTLSClient, req)
}
